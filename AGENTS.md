...
| 修改 BrowserOpener、占位页、终端 URL fallback 或对应 scripted adapter | `docs/architecture/OVERVIEW.md`；目标代码与测试 | 运行命令读 `docs/development/SETUP.md`；语义变化再读 PRD 第 7.1、16.1、17、19–20 节与 ADR 0001 |
